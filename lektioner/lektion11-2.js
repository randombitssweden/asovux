...
c.addEventListener("click", function(){
    ...
    if(pos.x <30) ctx.strokeStyle = "hsl(0,100%,50%)";
    else if (pos.x < 60 ) ctx.strokeStyle = "hsl(18,100%,50%)";
    else if (pos.x < 90 ) ctx.strokeStyle = "hsl(36,100%,50%)";
    else if (pos.x < 120 ) ctx.strokeStyle = "hsl(54,100%,50%)";
    else if (pos.x < 150 ) ctx.strokeStyle = "hsl(72,100%,50%)";
    else if (pos.x < 180 ) ctx.strokeStyle = "hsl(90,100%,50%)";
    else if (pos.x < 210 ) ctx.strokeStyle = "hsl(108,100%,50%)";
    else if (pos.x < 240 ) ctx.strokeStyle = "hsl(126,100%,50%)";
    else if (pos.x < 270 ) ctx.strokeStyle = "hsl(144,100%,50%)";
    else if (pos.x < 300 ) ctx.strokeStyle = "hsl(162,100%,50%)";
    else if (pos.x < 330 ) ctx.strokeStyle = "hsl(180,100%,50%)";
